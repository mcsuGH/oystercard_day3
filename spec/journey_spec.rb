...
describe Journey do
    ...
    let(:exit_station1) { double :exit_station, :zone =>2 }
    let(:exit_station2) { double :exit_station, :zone =>3 }
    let(:exit_station3) { double :exit_station, :zone =>4 }
    let(:exit_station4) { double :exit_station, :zone =>5 }
    let(:exit_station5) { double :exit_station, :zone =>6 }
    ...
    it "returns itself when exiting a journey" do
        expect(journey.finish(exit_station1)).to eq(journey)
    end
